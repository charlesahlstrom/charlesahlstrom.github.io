...
where N denotes the number of bonds in month <img src="https://render.githubusercontent.com/render/math?math=t">" and <img src="https://render.githubusercontent.com/render/math?math=S_{i,t}[k]"> is the spread of firm <img src="https://render.githubusercontent.com/render/math?math=i">'s bond <img src="https://render.githubusercontent.com/render/math?math=k">" in the same month. 
...
<img src="https://render.githubusercontent.com/render/math?math=\ln S_{i,t}[k] = \beta DFT_{i,t} + \gamma' \textbf{Z}_{i,t}[k] + \varepsilon_{i,t}[k]">
...
<img src="https://render.githubusercontent.com/render/math?math=\hat{S}_{i,t}[k] = \exp \left[ \hat{\beta}DFT_{i,t} + \hat{\gamma}' Z_{i,t}[k] + \frac{\hat{\sigma}^2}{2} \right]">
...
<img src="https://render.githubusercontent.com/render/math?math=\hat{S}^{GZ}_{i,t}[k] = \frac{1}{N} \sum_i \sum_k \hat{S}_{i,t}[k]">
...
<img src="https://render.githubusercontent.com/render/math?math=EBP_t = S_t^{GZ} - \hat{S}_t^{GZ}">
...
<img src="https://render.githubusercontent.com/render/math?math=P(NBER_{t,t+12}=1) = \Phi(\alpha + \beta EBP_t)">
